...
public class OpenIDCredentials {
   ...
   * @param requiredAuthorities The authorities required to authenticate (provided by the {@link uk.co.froot.demo.ember.auth.annotation.RestrictedTo} annotation)
   */
